...
$API_PATH='api.php';
$user='admin';
$pass='dc5ff50571b155d49240e8f71a22af37';
$TITLE='新睿智能视频解析';
$keywords='vip视频解析,vip视频在线解析,vip解析,万能vip视频解析,vip视频,vip视频,手机vip视频解析,手机在线解析vip视频,优酷vip解析,爱奇艺vip解析,腾讯vip解析,乐视vip解析,芒果vip解析';
$description='新睿解析VIP视频免费看，在线解析，vip视频解析，优酷vip解析，爱奇艺vip解析，腾讯vip解析，乐视vip解析，芒果vip解析方便广大用户VIP视频服务，最新电影最新电视剧在线免费观看';
...
$BOOK_INFO=array (
  'off' => '1',
  'info' => '<font size="6" color="#00FF00">本源码功能非常强大，更新及时，欢迎购买联系唯一客服QQ:345179552
<!--上方数字10为文字大小，可自行修改-->',
);
$templets=array (
  'off' => '0',
...
$BLACKLIST=array (
  ...
  array (
    ...
    array (
      'type' => '1',
      'action' => '1',
      'info' => 'exit("本站已开启防盗链，获取授权请联系本站管理员QQ:345179552");',
      'name' => '提示防盗链',
    ),
    1 => 
    array (
    ...
    array (
      'type' => '1',
      'action' => '1',
      'info' => 'exit("目标网站在黑名单中,请联系网站管理员QQ:345179552进行解除！");',
      'name' => '提示黑名单',
    ),
    3 => 
    array (
      'type' => '1',
      'action' => '1',
      'info' => 'echo "本站已开启防盗链，获取授权请联系本站管理员";header("Refresh:3;url=http://jx.xinr.vip");',
      'name' => '跳转首页',
    ),
    4 => 
    array (
...
$FOOTER_CODE=' <script>
    advertisement = new Array(3);
    advertisement[0] = \'<a href="广告链接"><img style="position:absolute; z-index:10; left:0px; border:0; bottom:0%" width="100%" height="0px" src="图片地址" /></a>\';
    advertisement[1] = \'<a href="广告链接"><img style="position:absolute; z-index:10; left:0px; border:0; bottom:0%" width="100%" height="0px"  src="图片地址" /></a>\';
    advertisement[2] = \'<a href="广告链接"><img style="position:absolute; z-index:10; left:0px; border:0; bottom:0%" width="100%" height="0px"  src="图片地址" /></a>\';
...
$LINK_URL=array (
  ...
  array (
    ...
    'num' => '100',
    'name' => '官方海洋CMS插件接口',
    'path' => 'http://jx.xinr.vip/parse/api.php?url=',
    'val' => 
    array (
      'success' => 'success',
      'url' => 'url',
...
$jx_url=array (
  0 => 'http://api.bbbbbb.me/jx/?url=',
  1 => 'https://vip.ooosoo.com/jx/?url=',
  2 => 'https://api.pangujiexi.com/player.php?url=',
  3 => 'https://api.bbbbbb.me/jx/v.php?url=',
  4 => 'http://api.7kki.cn/api/?url=',
);
$jx_link=array (
...
$play=array (
  ...
  array (
    ...
    'decode' => '//----------------------反调试代码开始---------------
        location.href="http://jx.xinr.vip";  //跳转网站

      //xyplay.echo("<br><br><br>检测到非法调试,请关闭后刷新重试!");  //用户窗口显示信息

       //setInterval("debugger;console.log(\'请勿非法调试,http://jx.xinr.vip\');");      //调试窗口显示信息
