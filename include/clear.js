$(function() {
    ...
    var clearAd = {
        ...
        clear: function() {
            ...
            var ad_id_name = [
                "__asdfewq_frame_0",
                "yx_1964010e75efbeac965dddfd54ed9759",
                "__asdfewq_frame_0",
            ...
            for (var i = 0; i < ad_css_name.length; i++) {
          	...
          	for (var i = 0; i < ad_attr_name.length; i++) {
    			$("div["+ad_attr_name[i]+"]").remove();
            }
    ...
    $(document).ready(function() {
        ...
        //为防止ajax异步延时加载的广告隔5s再清除一次
        setTimeout(function() {
            clearAd.init();
        }, 1000*5)
        //为防止ajax异步延时加载的广告隔7s再清除一次
        setTimeout(function() {
            clearAd.init();
        }, 1000*7)
    });
