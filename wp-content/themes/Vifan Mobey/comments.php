...
">
    ...
    ?>
    <li class="decmt-box">
        <p><a href="#addcomment">还没有任何评论!</a></p>
    </li>
    <?php
        } else {
...
<form id="commentform" name="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
    ...
    <ul>
        ...
        <li class="clearfix">
            <!-- Add Comment Button -->
          <a href="javascript:void(0);" onClick="Javascript:document.forms['commentform'].submit()"  class="btn btn-primary btn-block">  发表评论  </a> </li>
    </ul>
	</div>
