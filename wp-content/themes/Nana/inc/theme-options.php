...
$options = array(
    ...
    array(
        'name'  => '百度站点Token值',
        'desc'  => '填写在百度站长平台申请的Token值，<a class="button-primary" href="http://yigujin.wang/428.html" target="_blank">详细申请教程</a>',
        'id'    => "ygj_token_id",
        'type'  => 'text',
        'std'   => ''
    ),
    ...
    array(
        'name'  => '360自动收录私钥',
        'desc'  => '填写在360站长平台获得的私钥，<a class="button-primary" href="http://yigujin.wang/701.html" target="_blank">详细申请教程</a>',
        'id'    => "ygj_360sl_id",
        'type'  => 'text',
        'std'   => ''
    ),
    ...
    array(
        ...
        'type'  => 'textarea',
        'std'   => '投稿文章版权格式：
本文地址：http://yigujin.wang/701.html
...
版权声明：本文为原创文章，版权归 懿古今 所有，欢迎分享本文，转载请保留出处！'
	...
	array(	"name" => "页脚常用链接",
            ...
            "id" => "ygj_yjcylj",
            "type" => "textarea",
            "std" => '<li><span class="post_spliter">•</span><a href="http://yigujin.wang/three/" target="_blank">Three主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.wang/unite/" target="_blank">Unite主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.wang/mfbegin/" target="_blank">MFBegin主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.wang/673.html" target="_blank">NewUnite主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.wang/263.html" target="_blank">Mirror主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.wang/nana/" target="_blank">Nana主题</a></li><li><span class="post_spliter">•</span><a href="http://boke112.com/2914.html" target="_blank">赞助我们</a></li><li><span class="post_spliter">•</span><a href="http://boke112.com/" target="_blank">博客导航</a></li>'),
	...
	array(	"name" => "关注我们按钮一链接",
            ...
            "id" => "ygj_gzwm_lj1",
            "type" => "text",
            "std" => "http://user.qzone.qq.com/2226524923"),			
	...
	array(	"name" => "导航栏下方广告代码",
            ...
            "id" => "ygj_addd_c",
            "type" => "textarea",
            "std" => '<a href="http://boke112.com/" target="_blank"><img src="' . get_bloginfo('template_directory') . '/images/ad/adunite.jpg" alt="boke112导航_独立博客导航平台" /></a>'),
...
function ygj_options_page() {
    ...
    if ($_REQUEST['update']) echo '<div class="updated"><p><strong>Nana主题设置已保存！</strong></p></div>';
    if ($_REQUEST['reset']) echo '<div class="updated"><p><strong>Nana主题设置已重置。</strong></p></div>';
?>
...
<div class="wrap">
    ...
    <div class="ygjtips">    
    <p>当前主题:Nana&nbsp;1.03&nbsp;版 | 设计者：<a href="http://yigujin.wang/" target="_blank">懿古今</a> | <a href="http://yigujin.wang/nana" target="_blank">查看版本更新</a> | <a href="http://yigujin.wang/461.html" target="_blank">常见问题汇总</a> | <a href="http://boke112.com/2914.html" target="_blank">打赏我们</a> | 申请免费收录到 <a href="http://boke112.com/" target="_blank">boke112导航</a> </p>
    </div>
	<?php //获取所有站点分类id
...
<h2>主题的那些事</h2>
<p>懿古今第一次折腾出来的主题是<a target="_blank" href="http://yigujin.wang/mfbegin/">MFBegin主题</a>（模仿Begin的意思），是完全模仿知更鸟的Begin主题，后来因为涉及版权问题就紧急取消分享和下载。</p>
<p>后来就对这个MFBegin主题进行修改和调整，慢慢地就变成了<a target="_blank" href="http://yigujin.wang/three/">Three主题</a>（博客、杂志、导航三合一）和<a target="_blank" href="http://yigujin.wang/unite/">Unite主题</a>。
经过几天的努力，终于对Unite主题进行了二次开发，调整了博客和杂志原来的布局，修改并增加了一些功能，现在自觉主题修改的足够完整，故更名为Nana主题，以将其与Unite主题加以区分。</p>
<p>定名为Nana，是因为不懂起什么名字了，所以就用我老婆的一个字的拼音来重复命名。</p>
<p>在这里感谢知更鸟分享的<a target="_blank" href="http://zmingcx.com/wordpress-theme-ality.html">Ality主题</a>，感谢乐趣公园分享的<a target="_blank" href="http://googlo.me/archives/3589.html">Git主题</a>。正是由于他们的无私奉献，才让我能够持续学习到折腾主题的相关知识和乐趣，也正是因为他们的分享才让我折腾出这几个感觉还行的主题。当然，也要感谢一直支持<a target="_blank" href="http://yigujin.wang/unite/">懿古今</a>和<a target="_blank" href="http://boke112.com/">boke112导航</a>的朋友们，谢谢你们！</p>	
<h2>重要提示</h2>
<p>因为主题是免费的，所以希望使用本主题的博主站长们能够保留页脚的版权说明及链接。</p>	
<p><font color="#ff0000">当然如果想要删除版权请加懿古今(yigujin.wang)为全站友链，或者赞助懿古今(支付宝：yigujin@qq.com)20元，谢谢支持！</font></p>	
<p><font color="#ff0000">PS：如果不添加友链，也不赞助本站，就直接删除版权的，对此我也无能为力，只能视你为人品不及格而已。</font></p>	
<h2>支持懿古今</h2>
<p>如果您觉的这款主题很赞，欢迎您扫码支持懿古今！</p>
<p><font color="#ff0000">PS：赞助20元，可以光明正大地随意删除版权说明及链接哦！</font></p>
<img src="http://tp.yigujin.wang/shangyigujin.png"></img>
<h2>联系我们</h2>
<p>QQ号：2226524923</p>
<p>主题群：477678587<font color="#ff0000">（不保留版权，不允许加入）</font></p>
<a class="button button-primary" href="http://shang.qq.com/wpa/qunwpa?idkey=cd5af8f33d775bec6d4da58ae2adc1ded8d668f235509ab97cb9834465e05ec8" target="_blank">点击加入懿古今主题官方群</a>
<a class="button button-primary" href="http://yigujin.wang/zxly/" target="_blank">点击前往懿古今留言板</a>
</div>
<p class="submit">
...
function ygj_pointer_print_scripts() {
    ...
    jQuery(document).ready(function($) {
        ...
        $menuAppearance.pointer({
            content: '<h3>恭喜，Nana 主题1.02安装成功！</h3><p>该主题支持选项，请访问<a href="themes.php?page=theme-options.php">主题选项</a>页面进行配置。</p>',
            position: {
                edge: "left",
                align: "center"
            },
