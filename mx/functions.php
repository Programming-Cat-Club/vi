...
//本文来自http://www.lwxshow.com  
$main_prefix = 'wp_';  
$addi_prefixs = array('danmaku_','wp_');  
//添加功能到用户注册的钩子里  
add_action( 'user_register', 'update_capabilities' );  
function update_capabilities( $user_id ) {  
...
$myavatar = get_bloginfo('template_directory') . '/avatar';//默认图片路径
