...
<body>
    ...
    <div class="notfoud-container">
        ...
        <div class="notfound-btn-container">
            <a class="notfound-btn" href="https://www.dofan.cn/account">返回个人中心</a>
          	<a class="notfound-btn" href="https://www.dofan.cn/rank?tab=latest">返回首页</a>
        </div>
    </div>
	<embed src="https://a0.kuyingfang.cn/2018/09/aed3eb9a84b7c7becee333f32da2b590.mp3" width="0" height="0" type=audio/mpeg loop="0" autostart="1" volume="0">
</body>
</html>
