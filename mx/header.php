				...
				<?php }else{ ?>
					<div class="tool tool-me">
						<a href="<?= theme_cache::get_author_posts_url(theme_cache::get_current_user_id());?>">
							<img src="<?= theme_cache::get_avatar_url(theme_cache::get_current_user_id());?>" width="32" height="32" alt="avatar" class="avatar">&nbsp; <i class="fa fa-caret-down"></i>
						</a>
						<div class="box">
							<!-- points -->
							<div class="box-points">
								<?php if(class_exists('theme_custom_point')){ ?>
									<a href="<?= theme_custom_user_settings::get_tabs('history')['url'];?>">
										...
										<img src="<?php echo get_stylesheet_directory_uri().'/assets/images/avatar-1.png' ?>" width="16" height="16" alt=""/>
										<?php }else{ ?>
