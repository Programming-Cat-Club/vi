...
function tt_activate_registration_from_link($key)
{
	...
	$result = array(
		...
		"data"    => array("username" => $data["username"], "email" => $data["email"], "id" => $user_id)
		);
...
{
	$data = array("ID" => $user_id, "user_url" => $site, "description" => $description);
	...
	return array("success" => true, "message" => __("Update basic profiles successfully", "tt"));
}
...
function tt_update_extended_profiles($data)
{
	...
	return array("success" => true, "message" => __("Update extended profiles successfully", "tt"));
}
...
function tt_update_security_profiles($data)
{
	...
	tt_clear_cache_key_like("tt_cache_daily_vm_MeSettingsVM_user" . $data["ID"]);
	tt_clear_cache_key_like("tt_cache_daily_vm_UCProfileVM_author_" . $data["ID"]);
	return array("success" => true, "message" => __("Update security profiles successfully", "tt"));
}
