...
<footer class="footer simple-footer">
    ...
    <div class="foot-copyright pull-right">&copy;&nbsp;<?php echo tt_copyright_year(); ?><?php echo ' ' . get_bloginfo('name') . ' All Right Reserved · <b style="color: #ff4425;">♥</b>&nbsp;<a href="' . TT_SITE . '/tint.shtml" title="Tint" rel="link" target="_blank">Tint</a> & Design by <a href="' . TT_SITE . '" rel="link" title="WordPress主题">WordPress主题.</a>'; ?>
    </div>
</footer>
